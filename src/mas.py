...
from src.plugins.ImageGenerator import ImageGenerator
...
class MultiAgent:
    def __init__(self):
        ...
        self.dalle_model = os.getenv("AZURE_OPENAI_DALLE_ENDPOINT")
    ...
    def create_agents(self, dynamic_agents):
        ...
        for agent in dynamic_agents:
            ...
            #kernel.add_plugin(WebSearchEnginePlugin(BingConnector()), "WebSearch")  #this only works with AI Agent Service?  Convert it.
            kernel.add_plugin(PresentationPlugin(), "Presentation")
            kernel.add_plugin(ImageGenerator(), "ImageGenerator")
